#Essentially just a 2D grid of floats with some manipulation functions
# A HeightMap is often output from a map generating algorithm
...
class HeightMap(object):
    def __init__(self, width, height):
        ...
        self.mapping = self._get_setup()    #2D list of floats
